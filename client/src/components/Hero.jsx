...
const Hero = () => {
    ...
    const onSearch = async (e)=>{
        ...
        // add destination to seachedCities max 3 recent searched cities
  ...
  return (
    ...
    bg-no-repeat bg-cover bg-center h-screen'>
        <p className='bg-[#49B9FF]/50 px-3.5 py-1.0 rounded-full mt-20'>The Ultimate Hotel Experience</p>
